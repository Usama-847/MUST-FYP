...
const Dashboard = () => {
  ...
  const [dietPlans, setDietPlans] = useState([
    { id: 1, name: "Weight Loss Plan", status: "Active", adherence: 87, lastUpdated: "2025-02-28" },
    { id: 2, name: "Muscle Gain Diet", status: "Completed", adherence: 95, lastUpdated: "2025-02-20" },
    { id: 3, name: "Low Carb Plan", status: "Paused", adherence: 62, lastUpdated: "2025-02-15" },
    { id: 4, name: "Mediterranean Diet", status: "Active", adherence: 78, lastUpdated: "2025-02-25" }
  ]);
              ...
              <Card.Body>
                ...
                <div className="text-center my-4">
                  <div className="position-relative d-inline-block">
                    <div style={{ width: '180px', height: '180px' }} className="position-relative">
                      <div className="position-absolute top-0 start-0 w-100 h-100 d-flex align-items-center justify-content-center">
                        <div>
                          <h3 className="mb-0">{steps.toLocaleString()}</h3>
                          <small className="text-muted">of {stepsGoal.toLocaleString()} steps</small>
                        </div>
                      </div>
              ...
              <Card.Body>
                ...
                <div className="my-3">
                  <div className="d-flex justify-content-between mb-1">
                    <span>Calories</span>
                    <span>{nutritionSummary.calories.consumed} / {nutritionSummary.calories.goal} kcal</span>
                  </div>
                  <ProgressBar 
                ...
                <div className="my-3">
                  <div className="d-flex justify-content-between mb-1">
                    <span>Protein</span>
                    <span>{nutritionSummary.protein.consumed} / {nutritionSummary.protein.goal}g</span>
                  </div>
                  <ProgressBar 
                    variant="success"
                ...
                <div className="my-3">
                  <div className="d-flex justify-content-between mb-1">
                    <span>Carbs</span>
                    <span>{nutritionSummary.carbs.consumed} / {nutritionSummary.carbs.goal}g</span>
                  </div>
                  <ProgressBar 
                    variant="warning"
                ...
                <div className="my-3">
                  <div className="d-flex justify-content-between mb-1">
                    <span>Fat</span>
                    <span>{nutritionSummary.fat.consumed} / {nutritionSummary.fat.goal}g</span>
                  </div>
                  <ProgressBar 
                    variant="danger"
                          ...
                          <td>
                            <div className="d-flex align-items-center">
                              <ProgressBar 
                                ...
                                className="me-2"
                              />
                              <span className="text-muted small">{plan.adherence}%</span>
                            </div>
                          </td>
              ...
              <Card.Body>
                <Row>
                  <Col md={4} className="text-center border-end">
                    <h5>BMI</h5>
                    <h3 className={`mt-2 ${
                      userStats.bmi < 18.5 ? 'text-warning' : 
                      userStats.bmi < 25 ? 'text-success' : 
                      userStats.bmi < 30 ? 'text-warning' : 'text-danger'
                    }`}>{userStats.bmi}</h3>
                    <p className="text-muted">
                      {userStats.bmi < 18.5 ? 'Underweight' : 
                       userStats.bmi < 25 ? 'Normal' : 
                       userStats.bmi < 30 ? 'Overweight' : 'Obese'}
                    </p>
                  </Col>
                  <Col md={4} className="text-center border-end">
                    <h5>Weight</h5>
